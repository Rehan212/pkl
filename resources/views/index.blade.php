...
<body>
	...
	<section class="hero-section">
		<div class="hero-slider owl-carousel">
			<div class="hero-slide-item set-bg" data-setbg="assets/frontend/img/slider-bg-1.jpg">
				<div class="hs-text">
			...
			<div class="hero-slide-item set-bg" data-setbg="assets/frontend/img/slider-bg-2.jpg">
				<div class="hs-text">
					<h2 class="hs-title-1"><span>Healthy Recipes</span></h2>
					<h2 class="hs-title-2"><span>from the best chefs</span></h2>
					<h2 class="hs-title-3"><span>for all the foodies</span></h2>
		...
		<div class="container">
			<div class="add-warp">
				<div class="add-slider owl-carousel">
					<div class="as-item set-bg" data-setbg="assets/frontend/img/add/1.jpg"></div>
					<div class="as-item set-bg" data-setbg="assets/frontend/img/add/2.jpg"></div>
					<div class="as-item set-bg" data-setbg="assets/frontend/img/add/3.jpg"></div>
				</div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 ftw-warp">
					...
					<ul class="sp-recipes-list">
						<li>
							<div class="rl-thumb set-bg" data-setbg="assets/frontend/img/thumb/1.jpg"></div>
							<div class="rl-info">
						...
						<li>
							<div class="rl-thumb set-bg" data-setbg="assets/frontend/img/thumb/2.jpg"></div>
							<div class="rl-info">
								<span>March 14, 2018</span>
						...
						<li>
							<div class="rl-thumb set-bg" data-setbg="assets/frontend/img/thumb/3.jpg"></div>
							<div class="rl-info">
								<span>March 14, 2018</span>
						...
						<li>
							<div class="rl-thumb set-bg" data-setbg="assets/frontend/img/thumb/4.jpg"></div>
							<div class="rl-info">
								<span>March 14, 2018</span>
				...
				<div class="col-lg-4 col-md-6 ftw-warp">
					...
					<ul class="sp-recipes-list">
						<li>
							<div class="rl-thumb set-bg" data-setbg="assets/frontend/img/thumb/6.jpg"></div>
							<div class="rl-info">
								<span>March 14, 2018</span>
						...
						<li>
							<div class="rl-thumb set-bg" data-setbg="assets/frontend/img/thumb/7.jpg"></div>
							<div class="rl-info">
								<span>March 14, 2018</span>
								<h6>Baked Salmon</h6>
								<div class="rating">
						...
						<li>
							<div class="rl-thumb set-bg" data-setbg="assets/frontend/img/thumb/8.jpg"></div>
							<div class="rl-info">
								<span>March 14, 2018</span>
						...
						<li>
							<div class="rl-thumb set-bg" data-setbg="assets/frontend/img/thumb/9.jpg"></div>
							<div class="rl-info">
								<span>March 14, 2018</span>
						...
						<li>
							<div class="rl-thumb set-bg" data-setbg="assets/frontend/img/thumb/10.jpg"></div>
							<div class="rl-info">
								<span>March 14, 2018</span>
								<h6>Vegan Food</h6>
								<div class="rating">
				...
				<div class="col-lg-4">
					<div class="sp-blog-item">
						<div class="blog-thubm">
							<img src="assets/frontend/img/blog/1.jpg" alt="">
							<div class="blog-date">
			...
			<div class="row">
				<div class="col-lg-6 col-md-8 offset-lg-0 offset-md-2">
					<div class="review-item">
						<div class="review-thumb set-bg" data-setbg="assets/frontend/img/thumb/11.jpg">
						...
						<div class="review-text">
							...
							<div class="author-meta">
								<div class="author-pic set-bg" data-setbg="assets/frontend/img/author.jpg"></div>
								<p>By Janice Smith</p>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-6 col-md-8 offset-lg-0 offset-md-2">
					<div class="review-item">
						<div class="review-thumb set-bg" data-setbg="assets/frontend/img/thumb/12.jpg">
							<div class="review-date">
								<span>May 04, 2018</span>
							</div>
						</div>
